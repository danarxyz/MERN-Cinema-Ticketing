    ...
    <div id="Content-Container" className="relative flex flex-col w-full max-w-[640px] min-h-screen mx-auto bg-[linear-gradient(179.86deg,_#000000_40.82%,_#0E0E24_99.88%)] overflow-x-hidden text-white">
        <div className="flex flex-col max-h-screen">
            <div id="Background" className="relative w-full overflow-hidden">
                ...
                <img src="/assets/images/backgrounds/details.png" className="w-full h-full object-cover" alt="background"/>
            </div>
            <div className="relative flex flex-col items-center gap-[30px] mb-[70px] mt-auto px-5">
                ...
                <div className="flex flex-col gap-3 w-[220px]">
                    <Link to={"/"} className="w-full rounded-full p-[12px_18px] bg-white font-bold text-premiere-black text-center">Book More</Link>
