        ...
        <div className="flex flex-col max-h-screen">
            ...
            <div className="relative flex flex-col items-center gap-[30px] mb-[70px] mt-auto px-5">
                <div className="flex flex-col w-[340px] gap-[6px] items-center">
                    ...
                    <h1 className="font-bold text-[26px] leading-[39px]">Topup Successful</h1>
                    <p className="text-center">Kami telah mengupdate saldo Ewallet anda silahkan periksa kembali</p>
                </div>
                <div className="flex flex-col gap-3 w-[220px]">
                    <Link to={'/wallet'} className="w-full rounded-full p-[12px_18px] bg-white font-bold text-premiere-black text-center">View My Ewallet</Link>
                    <Link to={'/wallet/topup'} className="w-full rounded-full p-[12px_18px] bg-white/10 font-bold text-center backdrop-blur-sm">Topup Again</Link>
                </div>
            </div>
        </div>
    </div>
